...
import org.phoebus.applications.pvtable.ui.SaveRestore;
...
//                snapshot_button = createButton("snapshot.png", Messages.Snapshot_TT, event -> model.save()),
                snapshot_button = createButton("snapshot.png", Messages.Snapshot_TT, new EventHandler<ActionEvent>() {
                    @Override
    ...
    private void hookDragAndDrop() {
        ...
        table.setOnDragDropped(event ->
        {
            ...
            if (dragged_items != null) {   // Move items within this table
                for (TableItemProxy proxy : dragged_items) {
                    model.removeItem(proxy.getItem());
